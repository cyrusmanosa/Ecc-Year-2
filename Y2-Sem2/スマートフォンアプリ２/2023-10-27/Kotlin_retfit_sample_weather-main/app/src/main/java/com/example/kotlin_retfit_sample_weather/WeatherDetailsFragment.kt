...
class WeatherDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        parentFragmentManager.setFragmentResultListener(
            ...
            val selectWeather: Weather = bundle.getParcelable(WeatherListFragment.SELECTED_WEATHER)!!
            ...
            selectWeather.let {
                ...
                binding.tvMinTemp.text = "最低気温: ${it.main.temp_min}°C"
                binding.tvMaxTemp.text = "最高気温: ${it.main.temp_max}°C"
