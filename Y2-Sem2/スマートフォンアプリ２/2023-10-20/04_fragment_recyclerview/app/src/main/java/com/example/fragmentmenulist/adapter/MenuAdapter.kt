...
class MenuAdapter(private val MfileList:List<Menu>, private val onMenuClicked:((Menu) -> Unit)) : RecyclerView.Adapter<MenuAdapter.MenuViewHolder>(){
    ...
    inner class MenuViewHolder(private val binding: ProfileItemBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(plofile:Menu){
            ...
            binding.tvCategory.text = plofile.category
